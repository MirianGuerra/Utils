...
if __name__ == "__main__":
    ...
    for prefix in LOTE_006:
        host = "172.16.0.37"
        port = 22  # Porta padrão SSH
        username = "root"
        password = "IA*SB#PXhbiG"
        remote_dir = "/bam/LOTE_006/"
        local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
        prefix = prefix

        baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)

    for prefix in LOTE_008:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_008/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)

    for prefix in LOTE_009:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_009/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)
            
    for prefix in LOTE_011:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_011/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)
            
    for prefix in LOTE_013:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_013/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)
            
    for prefix in LOTE_017:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_017/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)
            
    for prefix in LOTE_020:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_020/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)
            
    for prefix in LOTE_021:
            host = "172.16.0.37"
            port = 22  # Porta padrão SSH
            username = "root"
            password = "IA*SB#PXhbiG"
            remote_dir = "/bam/LOTE_021/"
            local_dir = "/media/hacpom03/HD_00050747/Leticia/BAM_BAI/"
            prefix = prefix

            baixar_arquivos_servidor_backup_comecando_por_nome(host, port, username, password, remote_dir, local_dir, prefix)

#nome_arquivo_md5_origem = input('Entre com o nome de arquivo de origem: ')
#nome_arquivo_md5_destino = input('Entre com o nome de arquivo de destino: ')

#checar_md5('/home/hacpom03/Documentos/EGA/Ariane/md5_hd.txt', '/home/hacpom03/Documentos/EGA/Ariane/md5_servidor_backup.txt')